...
func (p NullType) String() string {
	switch p {
	case NullType___NULL__:
		return "__NULL__"
	case NullType_NaN:
		return "NaN"
	case NullType_BAD_DATA:
		return "BAD_DATA"
	case NullType_BAD_TYPE:
		return "BAD_TYPE"
	case NullType_ERR_OVERFLOW:
		return "ERR_OVERFLOW"
	case NullType_UNKNOWN_PROP:
		return "UNKNOWN_PROP"
	case NullType_DIV_BY_ZERO:
		return "DIV_BY_ZERO"
	case NullType_OUT_OF_RANGE:
		return "OUT_OF_RANGE"
	}
	return "<UNSET>"
}
...
func NullTypeFromString(s string) (NullType, error) {
	switch s {
	case "__NULL__":
		return NullType___NULL__, nil
	case "NaN":
		return NullType_NaN, nil
	case "BAD_DATA":
		return NullType_BAD_DATA, nil
	case "BAD_TYPE":
		return NullType_BAD_TYPE, nil
	case "ERR_OVERFLOW":
		return NullType_ERR_OVERFLOW, nil
	case "UNKNOWN_PROP":
		return NullType_UNKNOWN_PROP, nil
	case "DIV_BY_ZERO":
		return NullType_DIV_BY_ZERO, nil
	case "OUT_OF_RANGE":
		return NullType_OUT_OF_RANGE, nil
	}
...
func (p PropertyType) String() string {
	...
	case PropertyType_STRING:
		return "STRING"
	case PropertyType_FIXED_STRING:
		return "FIXED_STRING"
	...
	case PropertyType_INT32:
		return "INT32"
	case PropertyType_TIMESTAMP:
		return "TIMESTAMP"
	case PropertyType_DURATION:
		return "DURATION"
	case PropertyType_DATE:
		return "DATE"
	case PropertyType_DATETIME:
		return "DATETIME"
	case PropertyType_TIME:
		return "TIME"
	case PropertyType_GEOGRAPHY:
		return "GEOGRAPHY"
	}
	return "<UNSET>"
}
...
func PropertyTypeFromString(s string) (PropertyType, error) {
	switch s {
	case "UNKNOWN":
		return PropertyType_UNKNOWN, nil
	case "BOOL":
		return PropertyType_BOOL, nil
	case "INT64":
		return PropertyType_INT64, nil
	case "VID":
		return PropertyType_VID, nil
	case "FLOAT":
		return PropertyType_FLOAT, nil
	case "DOUBLE":
		return PropertyType_DOUBLE, nil
	case "STRING":
		return PropertyType_STRING, nil
	case "FIXED_STRING":
		return PropertyType_FIXED_STRING, nil
	case "INT8":
		return PropertyType_INT8, nil
	case "INT16":
		return PropertyType_INT16, nil
	case "INT32":
		return PropertyType_INT32, nil
	case "TIMESTAMP":
		return PropertyType_TIMESTAMP, nil
	case "DURATION":
		return PropertyType_DURATION, nil
	case "DATE":
		return PropertyType_DATE, nil
	case "DATETIME":
		return PropertyType_DATETIME, nil
	case "TIME":
		return PropertyType_TIME, nil
	case "GEOGRAPHY":
		return PropertyType_GEOGRAPHY, nil
	}
...
func (p ErrorCode) String() string {
	switch p {
	case ErrorCode_SUCCEEDED:
		return "SUCCEEDED"
	case ErrorCode_E_DISCONNECTED:
		return "E_DISCONNECTED"
	case ErrorCode_E_FAIL_TO_CONNECT:
		return "E_FAIL_TO_CONNECT"
	case ErrorCode_E_RPC_FAILURE:
		return "E_RPC_FAILURE"
	case ErrorCode_E_LEADER_CHANGED:
		return "E_LEADER_CHANGED"
	case ErrorCode_E_SPACE_NOT_FOUND:
		return "E_SPACE_NOT_FOUND"
	case ErrorCode_E_TAG_NOT_FOUND:
		return "E_TAG_NOT_FOUND"
	case ErrorCode_E_EDGE_NOT_FOUND:
		return "E_EDGE_NOT_FOUND"
	case ErrorCode_E_INDEX_NOT_FOUND:
		return "E_INDEX_NOT_FOUND"
	case ErrorCode_E_EDGE_PROP_NOT_FOUND:
		return "E_EDGE_PROP_NOT_FOUND"
	case ErrorCode_E_TAG_PROP_NOT_FOUND:
		return "E_TAG_PROP_NOT_FOUND"
	case ErrorCode_E_ROLE_NOT_FOUND:
		return "E_ROLE_NOT_FOUND"
	case ErrorCode_E_CONFIG_NOT_FOUND:
		return "E_CONFIG_NOT_FOUND"
	case ErrorCode_E_MACHINE_NOT_FOUND:
		return "E_MACHINE_NOT_FOUND"
	case ErrorCode_E_ZONE_NOT_FOUND:
		return "E_ZONE_NOT_FOUND"
	case ErrorCode_E_LISTENER_NOT_FOUND:
		return "E_LISTENER_NOT_FOUND"
	case ErrorCode_E_PART_NOT_FOUND:
		return "E_PART_NOT_FOUND"
	case ErrorCode_E_KEY_NOT_FOUND:
		return "E_KEY_NOT_FOUND"
	case ErrorCode_E_USER_NOT_FOUND:
		return "E_USER_NOT_FOUND"
	case ErrorCode_E_STATS_NOT_FOUND:
		return "E_STATS_NOT_FOUND"
	case ErrorCode_E_SERVICE_NOT_FOUND:
		return "E_SERVICE_NOT_FOUND"
	case ErrorCode_E_DRAINER_NOT_FOUND:
		return "E_DRAINER_NOT_FOUND"
	case ErrorCode_E_DRAINER_CLIENT_NOT_FOUND:
		return "E_DRAINER_CLIENT_NOT_FOUND"
	case ErrorCode_E_PART_STOPPED:
		return "E_PART_STOPPED"
	case ErrorCode_E_BACKUP_FAILED:
		return "E_BACKUP_FAILED"
	case ErrorCode_E_BACKUP_EMPTY_TABLE:
		return "E_BACKUP_EMPTY_TABLE"
	case ErrorCode_E_BACKUP_TABLE_FAILED:
		return "E_BACKUP_TABLE_FAILED"
	case ErrorCode_E_PARTIAL_RESULT:
		return "E_PARTIAL_RESULT"
	case ErrorCode_E_REBUILD_INDEX_FAILED:
		return "E_REBUILD_INDEX_FAILED"
	case ErrorCode_E_INVALID_PASSWORD:
		return "E_INVALID_PASSWORD"
	case ErrorCode_E_FAILED_GET_ABS_PATH:
		return "E_FAILED_GET_ABS_PATH"
	case ErrorCode_E_LISTENER_PROGRESS_FAILED:
		return "E_LISTENER_PROGRESS_FAILED"
	case ErrorCode_E_SYNC_LISTENER_NOT_FOUND:
		return "E_SYNC_LISTENER_NOT_FOUND"
	case ErrorCode_E_DRAINER_PROGRESS_FAILED:
		return "E_DRAINER_PROGRESS_FAILED"
	case ErrorCode_E_PART_DISABLED:
		return "E_PART_DISABLED"
	case ErrorCode_E_PART_ALREADY_STARTED:
		return "E_PART_ALREADY_STARTED"
	case ErrorCode_E_PART_ALREADY_STOPPED:
		return "E_PART_ALREADY_STOPPED"
	case ErrorCode_E_BAD_USERNAME_PASSWORD:
		return "E_BAD_USERNAME_PASSWORD"
	case ErrorCode_E_SESSION_INVALID:
		return "E_SESSION_INVALID"
	case ErrorCode_E_SESSION_TIMEOUT:
		return "E_SESSION_TIMEOUT"
	case ErrorCode_E_SYNTAX_ERROR:
		return "E_SYNTAX_ERROR"
	case ErrorCode_E_EXECUTION_ERROR:
		return "E_EXECUTION_ERROR"
	case ErrorCode_E_STATEMENT_EMPTY:
		return "E_STATEMENT_EMPTY"
	case ErrorCode_E_BAD_PERMISSION:
		return "E_BAD_PERMISSION"
	case ErrorCode_E_SEMANTIC_ERROR:
		return "E_SEMANTIC_ERROR"
	case ErrorCode_E_TOO_MANY_CONNECTIONS:
		return "E_TOO_MANY_CONNECTIONS"
	case ErrorCode_E_PARTIAL_SUCCEEDED:
		return "E_PARTIAL_SUCCEEDED"
	case ErrorCode_E_NO_HOSTS:
		return "E_NO_HOSTS"
	case ErrorCode_E_EXISTED:
		return "E_EXISTED"
	case ErrorCode_E_INVALID_HOST:
		return "E_INVALID_HOST"
	case ErrorCode_E_UNSUPPORTED:
		return "E_UNSUPPORTED"
	case ErrorCode_E_NOT_DROP:
		return "E_NOT_DROP"
	case ErrorCode_E_BALANCER_RUNNING:
		return "E_BALANCER_RUNNING"
	case ErrorCode_E_CONFIG_IMMUTABLE:
		return "E_CONFIG_IMMUTABLE"
	case ErrorCode_E_CONFLICT:
		return "E_CONFLICT"
	case ErrorCode_E_INVALID_PARM:
		return "E_INVALID_PARM"
	case ErrorCode_E_WRONGCLUSTER:
		return "E_WRONGCLUSTER"
	case ErrorCode_E_ZONE_NOT_ENOUGH:
		return "E_ZONE_NOT_ENOUGH"
	case ErrorCode_E_ZONE_IS_EMPTY:
		return "E_ZONE_IS_EMPTY"
	case ErrorCode_E_LISTENER_CONFLICT:
		return "E_LISTENER_CONFLICT"
	case ErrorCode_E_SCHEMA_NAME_EXISTS:
		return "E_SCHEMA_NAME_EXISTS"
	case ErrorCode_E_RELATED_INDEX_EXISTS:
		return "E_RELATED_INDEX_EXISTS"
	case ErrorCode_E_RELATED_SPACE_EXISTS:
		return "E_RELATED_SPACE_EXISTS"
	case ErrorCode_E_RELATED_FULLTEXT_INDEX_EXISTS:
		return "E_RELATED_FULLTEXT_INDEX_EXISTS"
	case ErrorCode_E_HISTORY_CONFLICT:
		return "E_HISTORY_CONFLICT"
	case ErrorCode_E_STORE_FAILURE:
		return "E_STORE_FAILURE"
	case ErrorCode_E_STORE_SEGMENT_ILLEGAL:
		return "E_STORE_SEGMENT_ILLEGAL"
	case ErrorCode_E_BAD_BALANCE_PLAN:
		return "E_BAD_BALANCE_PLAN"
	case ErrorCode_E_BALANCED:
		return "E_BALANCED"
	case ErrorCode_E_NO_RUNNING_BALANCE_PLAN:
		return "E_NO_RUNNING_BALANCE_PLAN"
	case ErrorCode_E_NO_VALID_HOST:
		return "E_NO_VALID_HOST"
	case ErrorCode_E_CORRUPTED_BALANCE_PLAN:
		return "E_CORRUPTED_BALANCE_PLAN"
	case ErrorCode_E_NO_INVALID_BALANCE_PLAN:
		return "E_NO_INVALID_BALANCE_PLAN"
	case ErrorCode_E_NO_VALID_DRAINER:
		return "E_NO_VALID_DRAINER"
	case ErrorCode_E_IMPROPER_ROLE:
		return "E_IMPROPER_ROLE"
	case ErrorCode_E_INVALID_PARTITION_NUM:
		return "E_INVALID_PARTITION_NUM"
	case ErrorCode_E_INVALID_REPLICA_FACTOR:
		return "E_INVALID_REPLICA_FACTOR"
	case ErrorCode_E_INVALID_CHARSET:
		return "E_INVALID_CHARSET"
	case ErrorCode_E_INVALID_COLLATE:
		return "E_INVALID_COLLATE"
	case ErrorCode_E_CHARSET_COLLATE_NOT_MATCH:
		return "E_CHARSET_COLLATE_NOT_MATCH"
	case ErrorCode_E_PRIVILEGE_ALL_TAG_EDGE_SETTLED:
		return "E_PRIVILEGE_ALL_TAG_EDGE_SETTLED"
	case ErrorCode_E_PRIVILEGE_NOT_EXIST:
		return "E_PRIVILEGE_NOT_EXIST"
	case ErrorCode_E_PRIVILEGE_NEED_BASIC_ROLE:
		return "E_PRIVILEGE_NEED_BASIC_ROLE"
	case ErrorCode_E_PRIVILEGE_ACTION_INVALID:
		return "E_PRIVILEGE_ACTION_INVALID"
	case ErrorCode_E_SNAPSHOT_FAILURE:
		return "E_SNAPSHOT_FAILURE"
	case ErrorCode_E_SNAPSHOT_RUNNING_JOBS:
		return "E_SNAPSHOT_RUNNING_JOBS"
	case ErrorCode_E_SNAPSHOT_NOT_FOUND:
		return "E_SNAPSHOT_NOT_FOUND"
	case ErrorCode_E_BLOCK_WRITE_FAILURE:
		return "E_BLOCK_WRITE_FAILURE"
	case ErrorCode_E_REBUILD_INDEX_FAILURE:
		return "E_REBUILD_INDEX_FAILURE"
	case ErrorCode_E_INDEX_WITH_TTL:
		return "E_INDEX_WITH_TTL"
	case ErrorCode_E_ADD_JOB_FAILURE:
		return "E_ADD_JOB_FAILURE"
	case ErrorCode_E_STOP_JOB_FAILURE:
		return "E_STOP_JOB_FAILURE"
	case ErrorCode_E_SAVE_JOB_FAILURE:
		return "E_SAVE_JOB_FAILURE"
	case ErrorCode_E_BALANCER_FAILURE:
		return "E_BALANCER_FAILURE"
	case ErrorCode_E_JOB_NOT_FINISHED:
		return "E_JOB_NOT_FINISHED"
	case ErrorCode_E_TASK_REPORT_OUT_DATE:
		return "E_TASK_REPORT_OUT_DATE"
	case ErrorCode_E_JOB_NOT_IN_SPACE:
		return "E_JOB_NOT_IN_SPACE"
	case ErrorCode_E_JOB_NEED_RECOVER:
		return "E_JOB_NEED_RECOVER"
	case ErrorCode_E_JOB_ALREADY_FINISH:
		return "E_JOB_ALREADY_FINISH"
	case ErrorCode_E_JOB_SUBMITTED:
		return "E_JOB_SUBMITTED"
	case ErrorCode_E_JOB_NOT_STOPPABLE:
		return "E_JOB_NOT_STOPPABLE"
	case ErrorCode_E_JOB_HAS_NO_TARGET_STORAGE:
		return "E_JOB_HAS_NO_TARGET_STORAGE"
	case ErrorCode_E_INVALID_JOB:
		return "E_INVALID_JOB"
	case ErrorCode_E_BACKUP_RUNNING_JOBS:
		return "E_BACKUP_RUNNING_JOBS"
	case ErrorCode_E_BACKUP_SPACE_NOT_FOUND:
		return "E_BACKUP_SPACE_NOT_FOUND"
	case ErrorCode_E_RESTORE_FAILURE:
		return "E_RESTORE_FAILURE"
	case ErrorCode_E_SESSION_NOT_FOUND:
		return "E_SESSION_NOT_FOUND"
	case ErrorCode_E_LIST_CLUSTER_FAILURE:
		return "E_LIST_CLUSTER_FAILURE"
	case ErrorCode_E_LIST_CLUSTER_GET_ABS_PATH_FAILURE:
		return "E_LIST_CLUSTER_GET_ABS_PATH_FAILURE"
	case ErrorCode_E_LIST_CLUSTER_NO_AGENT_FAILURE:
		return "E_LIST_CLUSTER_NO_AGENT_FAILURE"
	case ErrorCode_E_QUERY_NOT_FOUND:
		return "E_QUERY_NOT_FOUND"
	case ErrorCode_E_AGENT_HB_FAILUE:
		return "E_AGENT_HB_FAILUE"
	case ErrorCode_E_INVALID_VARIABLE:
		return "E_INVALID_VARIABLE"
	case ErrorCode_E_VARIABLE_TYPE_VALUE_MISMATCH:
		return "E_VARIABLE_TYPE_VALUE_MISMATCH"
	case ErrorCode_E_HOST_CAN_NOT_BE_ADDED:
		return "E_HOST_CAN_NOT_BE_ADDED"
	case ErrorCode_E_ACCESS_ES_FAILURE:
		return "E_ACCESS_ES_FAILURE"
	case ErrorCode_E_GRAPH_MEMORY_EXCEEDED:
		return "E_GRAPH_MEMORY_EXCEEDED"
	case ErrorCode_E_CONSENSUS_ERROR:
		return "E_CONSENSUS_ERROR"
	case ErrorCode_E_KEY_HAS_EXISTS:
		return "E_KEY_HAS_EXISTS"
	case ErrorCode_E_DATA_TYPE_MISMATCH:
		return "E_DATA_TYPE_MISMATCH"
	case ErrorCode_E_INVALID_FIELD_VALUE:
		return "E_INVALID_FIELD_VALUE"
	case ErrorCode_E_INVALID_OPERATION:
		return "E_INVALID_OPERATION"
	case ErrorCode_E_NOT_NULLABLE:
		return "E_NOT_NULLABLE"
	case ErrorCode_E_FIELD_UNSET:
		return "E_FIELD_UNSET"
	case ErrorCode_E_OUT_OF_RANGE:
		return "E_OUT_OF_RANGE"
	case ErrorCode_E_DATA_CONFLICT_ERROR:
		return "E_DATA_CONFLICT_ERROR"
	case ErrorCode_E_WRITE_STALLED:
		return "E_WRITE_STALLED"
	case ErrorCode_E_IMPROPER_DATA_TYPE:
		return "E_IMPROPER_DATA_TYPE"
	case ErrorCode_E_INVALID_SPACEVIDLEN:
		return "E_INVALID_SPACEVIDLEN"
	case ErrorCode_E_INVALID_FILTER:
		return "E_INVALID_FILTER"
	case ErrorCode_E_INVALID_UPDATER:
		return "E_INVALID_UPDATER"
	case ErrorCode_E_INVALID_STORE:
		return "E_INVALID_STORE"
	case ErrorCode_E_INVALID_PEER:
		return "E_INVALID_PEER"
	case ErrorCode_E_RETRY_EXHAUSTED:
		return "E_RETRY_EXHAUSTED"
	case ErrorCode_E_TRANSFER_LEADER_FAILED:
		return "E_TRANSFER_LEADER_FAILED"
	case ErrorCode_E_INVALID_STAT_TYPE:
		return "E_INVALID_STAT_TYPE"
	case ErrorCode_E_INVALID_VID:
		return "E_INVALID_VID"
	case ErrorCode_E_NO_TRANSFORMED:
		return "E_NO_TRANSFORMED"
	case ErrorCode_E_LOAD_META_FAILED:
		return "E_LOAD_META_FAILED"
	case ErrorCode_E_FAILED_TO_CHECKPOINT:
		return "E_FAILED_TO_CHECKPOINT"
	case ErrorCode_E_CHECKPOINT_BLOCKED:
		return "E_CHECKPOINT_BLOCKED"
	case ErrorCode_E_FILTER_OUT:
		return "E_FILTER_OUT"
	case ErrorCode_E_INVALID_DATA:
		return "E_INVALID_DATA"
	case ErrorCode_E_MUTATE_EDGE_CONFLICT:
		return "E_MUTATE_EDGE_CONFLICT"
	case ErrorCode_E_MUTATE_TAG_CONFLICT:
		return "E_MUTATE_TAG_CONFLICT"
	case ErrorCode_E_OUTDATED_LOCK:
		return "E_OUTDATED_LOCK"
	case ErrorCode_E_INVALID_TASK_PARA:
		return "E_INVALID_TASK_PARA"
	case ErrorCode_E_USER_CANCEL:
		return "E_USER_CANCEL"
	case ErrorCode_E_TASK_EXECUTION_FAILED:
		return "E_TASK_EXECUTION_FAILED"
	case ErrorCode_E_PLAN_IS_KILLED:
		return "E_PLAN_IS_KILLED"
	case ErrorCode_E_NO_TERM:
		return "E_NO_TERM"
	case ErrorCode_E_OUTDATED_TERM:
		return "E_OUTDATED_TERM"
	case ErrorCode_E_OUTDATED_EDGE:
		return "E_OUTDATED_EDGE"
	case ErrorCode_E_WRITE_WRITE_CONFLICT:
		return "E_WRITE_WRITE_CONFLICT"
	case ErrorCode_E_CLIENT_SERVER_INCOMPATIBLE:
		return "E_CLIENT_SERVER_INCOMPATIBLE"
	case ErrorCode_E_ID_FAILED:
		return "E_ID_FAILED"
	case ErrorCode_E_RAFT_UNKNOWN_PART:
		return "E_RAFT_UNKNOWN_PART"
	case ErrorCode_E_RAFT_LOG_GAP:
		return "E_RAFT_LOG_GAP"
	case ErrorCode_E_RAFT_LOG_STALE:
		return "E_RAFT_LOG_STALE"
	case ErrorCode_E_RAFT_TERM_OUT_OF_DATE:
		return "E_RAFT_TERM_OUT_OF_DATE"
	case ErrorCode_E_RAFT_UNKNOWN_APPEND_LOG:
		return "E_RAFT_UNKNOWN_APPEND_LOG"
	case ErrorCode_E_RAFT_WAITING_SNAPSHOT:
		return "E_RAFT_WAITING_SNAPSHOT"
	case ErrorCode_E_RAFT_SENDING_SNAPSHOT:
		return "E_RAFT_SENDING_SNAPSHOT"
	case ErrorCode_E_RAFT_INVALID_PEER:
		return "E_RAFT_INVALID_PEER"
	case ErrorCode_E_RAFT_NOT_READY:
		return "E_RAFT_NOT_READY"
	case ErrorCode_E_RAFT_STOPPED:
		return "E_RAFT_STOPPED"
	case ErrorCode_E_RAFT_BAD_ROLE:
		return "E_RAFT_BAD_ROLE"
	case ErrorCode_E_RAFT_WAL_FAIL:
		return "E_RAFT_WAL_FAIL"
	case ErrorCode_E_RAFT_HOST_STOPPED:
		return "E_RAFT_HOST_STOPPED"
	case ErrorCode_E_RAFT_TOO_MANY_REQUESTS:
		return "E_RAFT_TOO_MANY_REQUESTS"
	case ErrorCode_E_RAFT_PERSIST_SNAPSHOT_FAILED:
		return "E_RAFT_PERSIST_SNAPSHOT_FAILED"
	case ErrorCode_E_RAFT_RPC_EXCEPTION:
		return "E_RAFT_RPC_EXCEPTION"
	case ErrorCode_E_RAFT_NO_WAL_FOUND:
		return "E_RAFT_NO_WAL_FOUND"
	case ErrorCode_E_RAFT_HOST_PAUSED:
		return "E_RAFT_HOST_PAUSED"
	case ErrorCode_E_RAFT_WRITE_BLOCKED:
		return "E_RAFT_WRITE_BLOCKED"
	case ErrorCode_E_RAFT_BUFFER_OVERFLOW:
		return "E_RAFT_BUFFER_OVERFLOW"
	case ErrorCode_E_RAFT_ATOMIC_OP_FAILED:
		return "E_RAFT_ATOMIC_OP_FAILED"
	case ErrorCode_E_LEADER_LEASE_FAILED:
		return "E_LEADER_LEASE_FAILED"
	case ErrorCode_E_RAFT_CAUGHT_UP:
		return "E_RAFT_CAUGHT_UP"
	case ErrorCode_E_LOG_GAP:
		return "E_LOG_GAP"
	case ErrorCode_E_LOG_STALE:
		return "E_LOG_STALE"
	case ErrorCode_E_INVALID_DRAINER_STORE:
		return "E_INVALID_DRAINER_STORE"
	case ErrorCode_E_SPACE_MISMATCH:
		return "E_SPACE_MISMATCH"
	case ErrorCode_E_PART_MISMATCH:
		return "E_PART_MISMATCH"
	case ErrorCode_E_DATA_CONFLICT:
		return "E_DATA_CONFLICT"
	case ErrorCode_E_REQ_CONFLICT:
		return "E_REQ_CONFLICT"
	case ErrorCode_E_DATA_ILLEGAL:
		return "E_DATA_ILLEGAL"
	case ErrorCode_E_CACHE_CONFIG_ERROR:
		return "E_CACHE_CONFIG_ERROR"
	case ErrorCode_E_NOT_ENOUGH_SPACE:
		return "E_NOT_ENOUGH_SPACE"
	case ErrorCode_E_CACHE_MISS:
		return "E_CACHE_MISS"
	case ErrorCode_E_POOL_NOT_FOUND:
		return "E_POOL_NOT_FOUND"
	case ErrorCode_E_CACHE_WRITE_FAILURE:
		return "E_CACHE_WRITE_FAILURE"
	case ErrorCode_E_NODE_NUMBER_EXCEED_LIMIT:
		return "E_NODE_NUMBER_EXCEED_LIMIT"
	case ErrorCode_E_PARSING_LICENSE_FAILURE:
		return "E_PARSING_LICENSE_FAILURE"
	case ErrorCode_E_STORAGE_MEMORY_EXCEEDED:
		return "E_STORAGE_MEMORY_EXCEEDED"
	case ErrorCode_E_UNKNOWN:
		return "E_UNKNOWN"
	}
	return "<UNSET>"
}
...
func ErrorCodeFromString(s string) (ErrorCode, error) {
	switch s {
	case "SUCCEEDED":
		return ErrorCode_SUCCEEDED, nil
	case "E_DISCONNECTED":
		return ErrorCode_E_DISCONNECTED, nil
	case "E_FAIL_TO_CONNECT":
		return ErrorCode_E_FAIL_TO_CONNECT, nil
	case "E_RPC_FAILURE":
		return ErrorCode_E_RPC_FAILURE, nil
	case "E_LEADER_CHANGED":
		return ErrorCode_E_LEADER_CHANGED, nil
	case "E_SPACE_NOT_FOUND":
		return ErrorCode_E_SPACE_NOT_FOUND, nil
	case "E_TAG_NOT_FOUND":
		return ErrorCode_E_TAG_NOT_FOUND, nil
	case "E_EDGE_NOT_FOUND":
		return ErrorCode_E_EDGE_NOT_FOUND, nil
	case "E_INDEX_NOT_FOUND":
		return ErrorCode_E_INDEX_NOT_FOUND, nil
	case "E_EDGE_PROP_NOT_FOUND":
		return ErrorCode_E_EDGE_PROP_NOT_FOUND, nil
	case "E_TAG_PROP_NOT_FOUND":
		return ErrorCode_E_TAG_PROP_NOT_FOUND, nil
	case "E_ROLE_NOT_FOUND":
		return ErrorCode_E_ROLE_NOT_FOUND, nil
	case "E_CONFIG_NOT_FOUND":
		return ErrorCode_E_CONFIG_NOT_FOUND, nil
	case "E_MACHINE_NOT_FOUND":
		return ErrorCode_E_MACHINE_NOT_FOUND, nil
	case "E_ZONE_NOT_FOUND":
		return ErrorCode_E_ZONE_NOT_FOUND, nil
	case "E_LISTENER_NOT_FOUND":
		return ErrorCode_E_LISTENER_NOT_FOUND, nil
	case "E_PART_NOT_FOUND":
		return ErrorCode_E_PART_NOT_FOUND, nil
	case "E_KEY_NOT_FOUND":
		return ErrorCode_E_KEY_NOT_FOUND, nil
	case "E_USER_NOT_FOUND":
		return ErrorCode_E_USER_NOT_FOUND, nil
	case "E_STATS_NOT_FOUND":
		return ErrorCode_E_STATS_NOT_FOUND, nil
	case "E_SERVICE_NOT_FOUND":
		return ErrorCode_E_SERVICE_NOT_FOUND, nil
	case "E_DRAINER_NOT_FOUND":
		return ErrorCode_E_DRAINER_NOT_FOUND, nil
	case "E_DRAINER_CLIENT_NOT_FOUND":
		return ErrorCode_E_DRAINER_CLIENT_NOT_FOUND, nil
	case "E_PART_STOPPED":
		return ErrorCode_E_PART_STOPPED, nil
	case "E_BACKUP_FAILED":
		return ErrorCode_E_BACKUP_FAILED, nil
	case "E_BACKUP_EMPTY_TABLE":
		return ErrorCode_E_BACKUP_EMPTY_TABLE, nil
	case "E_BACKUP_TABLE_FAILED":
		return ErrorCode_E_BACKUP_TABLE_FAILED, nil
	case "E_PARTIAL_RESULT":
		return ErrorCode_E_PARTIAL_RESULT, nil
	case "E_REBUILD_INDEX_FAILED":
		return ErrorCode_E_REBUILD_INDEX_FAILED, nil
	case "E_INVALID_PASSWORD":
		return ErrorCode_E_INVALID_PASSWORD, nil
	case "E_FAILED_GET_ABS_PATH":
		return ErrorCode_E_FAILED_GET_ABS_PATH, nil
	case "E_LISTENER_PROGRESS_FAILED":
		return ErrorCode_E_LISTENER_PROGRESS_FAILED, nil
	case "E_SYNC_LISTENER_NOT_FOUND":
		return ErrorCode_E_SYNC_LISTENER_NOT_FOUND, nil
	case "E_DRAINER_PROGRESS_FAILED":
		return ErrorCode_E_DRAINER_PROGRESS_FAILED, nil
	case "E_PART_DISABLED":
		return ErrorCode_E_PART_DISABLED, nil
	case "E_PART_ALREADY_STARTED":
		return ErrorCode_E_PART_ALREADY_STARTED, nil
	case "E_PART_ALREADY_STOPPED":
		return ErrorCode_E_PART_ALREADY_STOPPED, nil
	case "E_BAD_USERNAME_PASSWORD":
		return ErrorCode_E_BAD_USERNAME_PASSWORD, nil
	case "E_SESSION_INVALID":
		return ErrorCode_E_SESSION_INVALID, nil
	case "E_SESSION_TIMEOUT":
		return ErrorCode_E_SESSION_TIMEOUT, nil
	case "E_SYNTAX_ERROR":
		return ErrorCode_E_SYNTAX_ERROR, nil
	case "E_EXECUTION_ERROR":
		return ErrorCode_E_EXECUTION_ERROR, nil
	case "E_STATEMENT_EMPTY":
		return ErrorCode_E_STATEMENT_EMPTY, nil
	case "E_BAD_PERMISSION":
		return ErrorCode_E_BAD_PERMISSION, nil
	case "E_SEMANTIC_ERROR":
		return ErrorCode_E_SEMANTIC_ERROR, nil
	case "E_TOO_MANY_CONNECTIONS":
		return ErrorCode_E_TOO_MANY_CONNECTIONS, nil
	case "E_PARTIAL_SUCCEEDED":
		return ErrorCode_E_PARTIAL_SUCCEEDED, nil
	case "E_NO_HOSTS":
		return ErrorCode_E_NO_HOSTS, nil
	case "E_EXISTED":
		return ErrorCode_E_EXISTED, nil
	case "E_INVALID_HOST":
		return ErrorCode_E_INVALID_HOST, nil
	case "E_UNSUPPORTED":
		return ErrorCode_E_UNSUPPORTED, nil
	case "E_NOT_DROP":
		return ErrorCode_E_NOT_DROP, nil
	case "E_BALANCER_RUNNING":
		return ErrorCode_E_BALANCER_RUNNING, nil
	case "E_CONFIG_IMMUTABLE":
		return ErrorCode_E_CONFIG_IMMUTABLE, nil
	case "E_CONFLICT":
		return ErrorCode_E_CONFLICT, nil
	case "E_INVALID_PARM":
		return ErrorCode_E_INVALID_PARM, nil
	case "E_WRONGCLUSTER":
		return ErrorCode_E_WRONGCLUSTER, nil
	case "E_ZONE_NOT_ENOUGH":
		return ErrorCode_E_ZONE_NOT_ENOUGH, nil
	case "E_ZONE_IS_EMPTY":
		return ErrorCode_E_ZONE_IS_EMPTY, nil
	case "E_LISTENER_CONFLICT":
		return ErrorCode_E_LISTENER_CONFLICT, nil
	case "E_SCHEMA_NAME_EXISTS":
		return ErrorCode_E_SCHEMA_NAME_EXISTS, nil
	case "E_RELATED_INDEX_EXISTS":
		return ErrorCode_E_RELATED_INDEX_EXISTS, nil
	case "E_RELATED_SPACE_EXISTS":
		return ErrorCode_E_RELATED_SPACE_EXISTS, nil
	case "E_RELATED_FULLTEXT_INDEX_EXISTS":
		return ErrorCode_E_RELATED_FULLTEXT_INDEX_EXISTS, nil
	case "E_HISTORY_CONFLICT":
		return ErrorCode_E_HISTORY_CONFLICT, nil
	case "E_STORE_FAILURE":
		return ErrorCode_E_STORE_FAILURE, nil
	case "E_STORE_SEGMENT_ILLEGAL":
		return ErrorCode_E_STORE_SEGMENT_ILLEGAL, nil
	case "E_BAD_BALANCE_PLAN":
		return ErrorCode_E_BAD_BALANCE_PLAN, nil
	case "E_BALANCED":
		return ErrorCode_E_BALANCED, nil
	case "E_NO_RUNNING_BALANCE_PLAN":
		return ErrorCode_E_NO_RUNNING_BALANCE_PLAN, nil
	case "E_NO_VALID_HOST":
		return ErrorCode_E_NO_VALID_HOST, nil
	case "E_CORRUPTED_BALANCE_PLAN":
		return ErrorCode_E_CORRUPTED_BALANCE_PLAN, nil
	case "E_NO_INVALID_BALANCE_PLAN":
		return ErrorCode_E_NO_INVALID_BALANCE_PLAN, nil
	case "E_NO_VALID_DRAINER":
		return ErrorCode_E_NO_VALID_DRAINER, nil
	case "E_IMPROPER_ROLE":
		return ErrorCode_E_IMPROPER_ROLE, nil
	case "E_INVALID_PARTITION_NUM":
		return ErrorCode_E_INVALID_PARTITION_NUM, nil
	case "E_INVALID_REPLICA_FACTOR":
		return ErrorCode_E_INVALID_REPLICA_FACTOR, nil
	case "E_INVALID_CHARSET":
		return ErrorCode_E_INVALID_CHARSET, nil
	case "E_INVALID_COLLATE":
		return ErrorCode_E_INVALID_COLLATE, nil
	case "E_CHARSET_COLLATE_NOT_MATCH":
		return ErrorCode_E_CHARSET_COLLATE_NOT_MATCH, nil
	case "E_PRIVILEGE_ALL_TAG_EDGE_SETTLED":
		return ErrorCode_E_PRIVILEGE_ALL_TAG_EDGE_SETTLED, nil
	case "E_PRIVILEGE_NOT_EXIST":
		return ErrorCode_E_PRIVILEGE_NOT_EXIST, nil
	case "E_PRIVILEGE_NEED_BASIC_ROLE":
		return ErrorCode_E_PRIVILEGE_NEED_BASIC_ROLE, nil
	case "E_PRIVILEGE_ACTION_INVALID":
		return ErrorCode_E_PRIVILEGE_ACTION_INVALID, nil
	case "E_SNAPSHOT_FAILURE":
		return ErrorCode_E_SNAPSHOT_FAILURE, nil
	case "E_SNAPSHOT_RUNNING_JOBS":
		return ErrorCode_E_SNAPSHOT_RUNNING_JOBS, nil
	case "E_SNAPSHOT_NOT_FOUND":
		return ErrorCode_E_SNAPSHOT_NOT_FOUND, nil
	case "E_BLOCK_WRITE_FAILURE":
		return ErrorCode_E_BLOCK_WRITE_FAILURE, nil
	case "E_REBUILD_INDEX_FAILURE":
		return ErrorCode_E_REBUILD_INDEX_FAILURE, nil
	case "E_INDEX_WITH_TTL":
		return ErrorCode_E_INDEX_WITH_TTL, nil
	case "E_ADD_JOB_FAILURE":
		return ErrorCode_E_ADD_JOB_FAILURE, nil
	case "E_STOP_JOB_FAILURE":
		return ErrorCode_E_STOP_JOB_FAILURE, nil
	case "E_SAVE_JOB_FAILURE":
		return ErrorCode_E_SAVE_JOB_FAILURE, nil
	case "E_BALANCER_FAILURE":
		return ErrorCode_E_BALANCER_FAILURE, nil
	case "E_JOB_NOT_FINISHED":
		return ErrorCode_E_JOB_NOT_FINISHED, nil
	case "E_TASK_REPORT_OUT_DATE":
		return ErrorCode_E_TASK_REPORT_OUT_DATE, nil
	case "E_JOB_NOT_IN_SPACE":
		return ErrorCode_E_JOB_NOT_IN_SPACE, nil
	case "E_JOB_NEED_RECOVER":
		return ErrorCode_E_JOB_NEED_RECOVER, nil
	case "E_JOB_ALREADY_FINISH":
		return ErrorCode_E_JOB_ALREADY_FINISH, nil
	case "E_JOB_SUBMITTED":
		return ErrorCode_E_JOB_SUBMITTED, nil
	case "E_JOB_NOT_STOPPABLE":
		return ErrorCode_E_JOB_NOT_STOPPABLE, nil
	case "E_JOB_HAS_NO_TARGET_STORAGE":
		return ErrorCode_E_JOB_HAS_NO_TARGET_STORAGE, nil
	case "E_INVALID_JOB":
		return ErrorCode_E_INVALID_JOB, nil
	case "E_BACKUP_RUNNING_JOBS":
		return ErrorCode_E_BACKUP_RUNNING_JOBS, nil
	case "E_BACKUP_SPACE_NOT_FOUND":
		return ErrorCode_E_BACKUP_SPACE_NOT_FOUND, nil
	case "E_RESTORE_FAILURE":
		return ErrorCode_E_RESTORE_FAILURE, nil
	case "E_SESSION_NOT_FOUND":
		return ErrorCode_E_SESSION_NOT_FOUND, nil
	case "E_LIST_CLUSTER_FAILURE":
		return ErrorCode_E_LIST_CLUSTER_FAILURE, nil
	case "E_LIST_CLUSTER_GET_ABS_PATH_FAILURE":
		return ErrorCode_E_LIST_CLUSTER_GET_ABS_PATH_FAILURE, nil
	case "E_LIST_CLUSTER_NO_AGENT_FAILURE":
		return ErrorCode_E_LIST_CLUSTER_NO_AGENT_FAILURE, nil
	case "E_QUERY_NOT_FOUND":
		return ErrorCode_E_QUERY_NOT_FOUND, nil
	case "E_AGENT_HB_FAILUE":
		return ErrorCode_E_AGENT_HB_FAILUE, nil
	case "E_INVALID_VARIABLE":
		return ErrorCode_E_INVALID_VARIABLE, nil
	case "E_VARIABLE_TYPE_VALUE_MISMATCH":
		return ErrorCode_E_VARIABLE_TYPE_VALUE_MISMATCH, nil
	case "E_HOST_CAN_NOT_BE_ADDED":
		return ErrorCode_E_HOST_CAN_NOT_BE_ADDED, nil
	case "E_ACCESS_ES_FAILURE":
		return ErrorCode_E_ACCESS_ES_FAILURE, nil
	case "E_GRAPH_MEMORY_EXCEEDED":
		return ErrorCode_E_GRAPH_MEMORY_EXCEEDED, nil
	case "E_CONSENSUS_ERROR":
		return ErrorCode_E_CONSENSUS_ERROR, nil
	case "E_KEY_HAS_EXISTS":
		return ErrorCode_E_KEY_HAS_EXISTS, nil
	case "E_DATA_TYPE_MISMATCH":
		return ErrorCode_E_DATA_TYPE_MISMATCH, nil
	case "E_INVALID_FIELD_VALUE":
		return ErrorCode_E_INVALID_FIELD_VALUE, nil
	case "E_INVALID_OPERATION":
		return ErrorCode_E_INVALID_OPERATION, nil
	case "E_NOT_NULLABLE":
		return ErrorCode_E_NOT_NULLABLE, nil
	case "E_FIELD_UNSET":
		return ErrorCode_E_FIELD_UNSET, nil
	case "E_OUT_OF_RANGE":
		return ErrorCode_E_OUT_OF_RANGE, nil
	case "E_DATA_CONFLICT_ERROR":
		return ErrorCode_E_DATA_CONFLICT_ERROR, nil
	case "E_WRITE_STALLED":
		return ErrorCode_E_WRITE_STALLED, nil
	case "E_IMPROPER_DATA_TYPE":
		return ErrorCode_E_IMPROPER_DATA_TYPE, nil
	case "E_INVALID_SPACEVIDLEN":
		return ErrorCode_E_INVALID_SPACEVIDLEN, nil
	case "E_INVALID_FILTER":
		return ErrorCode_E_INVALID_FILTER, nil
	case "E_INVALID_UPDATER":
		return ErrorCode_E_INVALID_UPDATER, nil
	case "E_INVALID_STORE":
		return ErrorCode_E_INVALID_STORE, nil
	case "E_INVALID_PEER":
		return ErrorCode_E_INVALID_PEER, nil
	case "E_RETRY_EXHAUSTED":
		return ErrorCode_E_RETRY_EXHAUSTED, nil
	case "E_TRANSFER_LEADER_FAILED":
		return ErrorCode_E_TRANSFER_LEADER_FAILED, nil
	case "E_INVALID_STAT_TYPE":
		return ErrorCode_E_INVALID_STAT_TYPE, nil
	case "E_INVALID_VID":
		return ErrorCode_E_INVALID_VID, nil
	case "E_NO_TRANSFORMED":
		return ErrorCode_E_NO_TRANSFORMED, nil
	case "E_LOAD_META_FAILED":
		return ErrorCode_E_LOAD_META_FAILED, nil
	case "E_FAILED_TO_CHECKPOINT":
		return ErrorCode_E_FAILED_TO_CHECKPOINT, nil
	case "E_CHECKPOINT_BLOCKED":
		return ErrorCode_E_CHECKPOINT_BLOCKED, nil
	case "E_FILTER_OUT":
		return ErrorCode_E_FILTER_OUT, nil
	case "E_INVALID_DATA":
		return ErrorCode_E_INVALID_DATA, nil
	case "E_MUTATE_EDGE_CONFLICT":
		return ErrorCode_E_MUTATE_EDGE_CONFLICT, nil
	case "E_MUTATE_TAG_CONFLICT":
		return ErrorCode_E_MUTATE_TAG_CONFLICT, nil
	case "E_OUTDATED_LOCK":
		return ErrorCode_E_OUTDATED_LOCK, nil
	case "E_INVALID_TASK_PARA":
		return ErrorCode_E_INVALID_TASK_PARA, nil
	case "E_USER_CANCEL":
		return ErrorCode_E_USER_CANCEL, nil
	case "E_TASK_EXECUTION_FAILED":
		return ErrorCode_E_TASK_EXECUTION_FAILED, nil
	case "E_PLAN_IS_KILLED":
		return ErrorCode_E_PLAN_IS_KILLED, nil
	case "E_NO_TERM":
		return ErrorCode_E_NO_TERM, nil
	case "E_OUTDATED_TERM":
		return ErrorCode_E_OUTDATED_TERM, nil
	case "E_OUTDATED_EDGE":
		return ErrorCode_E_OUTDATED_EDGE, nil
	case "E_WRITE_WRITE_CONFLICT":
		return ErrorCode_E_WRITE_WRITE_CONFLICT, nil
	case "E_CLIENT_SERVER_INCOMPATIBLE":
		return ErrorCode_E_CLIENT_SERVER_INCOMPATIBLE, nil
	case "E_ID_FAILED":
		return ErrorCode_E_ID_FAILED, nil
	case "E_RAFT_UNKNOWN_PART":
		return ErrorCode_E_RAFT_UNKNOWN_PART, nil
	case "E_RAFT_LOG_GAP":
		return ErrorCode_E_RAFT_LOG_GAP, nil
	case "E_RAFT_LOG_STALE":
		return ErrorCode_E_RAFT_LOG_STALE, nil
	case "E_RAFT_TERM_OUT_OF_DATE":
		return ErrorCode_E_RAFT_TERM_OUT_OF_DATE, nil
	case "E_RAFT_UNKNOWN_APPEND_LOG":
		return ErrorCode_E_RAFT_UNKNOWN_APPEND_LOG, nil
	case "E_RAFT_WAITING_SNAPSHOT":
		return ErrorCode_E_RAFT_WAITING_SNAPSHOT, nil
	case "E_RAFT_SENDING_SNAPSHOT":
		return ErrorCode_E_RAFT_SENDING_SNAPSHOT, nil
	case "E_RAFT_INVALID_PEER":
		return ErrorCode_E_RAFT_INVALID_PEER, nil
	case "E_RAFT_NOT_READY":
		return ErrorCode_E_RAFT_NOT_READY, nil
	case "E_RAFT_STOPPED":
		return ErrorCode_E_RAFT_STOPPED, nil
	case "E_RAFT_BAD_ROLE":
		return ErrorCode_E_RAFT_BAD_ROLE, nil
	case "E_RAFT_WAL_FAIL":
		return ErrorCode_E_RAFT_WAL_FAIL, nil
	case "E_RAFT_HOST_STOPPED":
		return ErrorCode_E_RAFT_HOST_STOPPED, nil
	case "E_RAFT_TOO_MANY_REQUESTS":
		return ErrorCode_E_RAFT_TOO_MANY_REQUESTS, nil
	case "E_RAFT_PERSIST_SNAPSHOT_FAILED":
		return ErrorCode_E_RAFT_PERSIST_SNAPSHOT_FAILED, nil
	case "E_RAFT_RPC_EXCEPTION":
		return ErrorCode_E_RAFT_RPC_EXCEPTION, nil
	case "E_RAFT_NO_WAL_FOUND":
		return ErrorCode_E_RAFT_NO_WAL_FOUND, nil
	case "E_RAFT_HOST_PAUSED":
		return ErrorCode_E_RAFT_HOST_PAUSED, nil
	case "E_RAFT_WRITE_BLOCKED":
		return ErrorCode_E_RAFT_WRITE_BLOCKED, nil
	case "E_RAFT_BUFFER_OVERFLOW":
		return ErrorCode_E_RAFT_BUFFER_OVERFLOW, nil
	case "E_RAFT_ATOMIC_OP_FAILED":
		return ErrorCode_E_RAFT_ATOMIC_OP_FAILED, nil
	case "E_LEADER_LEASE_FAILED":
		return ErrorCode_E_LEADER_LEASE_FAILED, nil
	case "E_RAFT_CAUGHT_UP":
		return ErrorCode_E_RAFT_CAUGHT_UP, nil
	case "E_LOG_GAP":
		return ErrorCode_E_LOG_GAP, nil
	case "E_LOG_STALE":
		return ErrorCode_E_LOG_STALE, nil
	case "E_INVALID_DRAINER_STORE":
		return ErrorCode_E_INVALID_DRAINER_STORE, nil
	case "E_SPACE_MISMATCH":
		return ErrorCode_E_SPACE_MISMATCH, nil
	case "E_PART_MISMATCH":
		return ErrorCode_E_PART_MISMATCH, nil
	case "E_DATA_CONFLICT":
		return ErrorCode_E_DATA_CONFLICT, nil
	case "E_REQ_CONFLICT":
		return ErrorCode_E_REQ_CONFLICT, nil
	case "E_DATA_ILLEGAL":
		return ErrorCode_E_DATA_ILLEGAL, nil
	case "E_CACHE_CONFIG_ERROR":
		return ErrorCode_E_CACHE_CONFIG_ERROR, nil
	case "E_NOT_ENOUGH_SPACE":
		return ErrorCode_E_NOT_ENOUGH_SPACE, nil
	case "E_CACHE_MISS":
		return ErrorCode_E_CACHE_MISS, nil
	case "E_POOL_NOT_FOUND":
		return ErrorCode_E_POOL_NOT_FOUND, nil
	case "E_CACHE_WRITE_FAILURE":
		return ErrorCode_E_CACHE_WRITE_FAILURE, nil
	case "E_NODE_NUMBER_EXCEED_LIMIT":
		return ErrorCode_E_NODE_NUMBER_EXCEED_LIMIT, nil
	case "E_PARSING_LICENSE_FAILURE":
		return ErrorCode_E_PARSING_LICENSE_FAILURE, nil
	case "E_STORAGE_MEMORY_EXCEEDED":
		return ErrorCode_E_STORAGE_MEMORY_EXCEEDED, nil
	case "E_UNKNOWN":
		return ErrorCode_E_UNKNOWN, nil
	}
...
func (p *SchemaID) LogValue() slog.Value {
	...
	v := thrift.SlogTStructWrapper{
		Type:  "*nebula.SchemaID",
		Value: p,
	}
	return slog.AnyValue(v)
}

var _ slog.LogValuer = (*SchemaID)(nil)
...
func (p *Time) Equals(other *Time) bool {
	...
	if p.Minute != other.Minute {
		return false
	}
	if p.Sec != other.Sec {
		return false
	}
	if p.Microsec != other.Microsec {
		return false
	}
	return true
}
...
func (p *DateTime) LogValue() slog.Value {
	...
	v := thrift.SlogTStructWrapper{
		Type:  "*nebula.DateTime",
		Value: p,
	}
	return slog.AnyValue(v)
}

var _ slog.LogValuer = (*DateTime)(nil)
...
func (p *Value) Equals(other *Value) bool {
	...
	if bytes.Compare(p.SVal, other.SVal) != 0 {
		return false
	}
	if !p.DVal.Equals(other.DVal) {
		return false
	}
	if !p.TVal.Equals(other.TVal) {
		return false
	}
	if !p.DtVal.Equals(other.DtVal) {
		return false
	}
	if !p.VVal.Equals(other.VVal) {
		return false
	}
	if !p.EVal.Equals(other.EVal) {
		return false
	}
	if !p.PVal.Equals(other.PVal) {
		return false
	}
	if !p.LVal.Equals(other.LVal) {
		return false
	}
	if !p.MVal.Equals(other.MVal) {
		return false
	}
	if !p.UVal.Equals(other.UVal) {
		return false
	}
	if !p.GVal.Equals(other.GVal) {
		return false
	}
	if !p.GgVal.Equals(other.GgVal) {
		return false
	}
	if !p.DuVal.Equals(other.DuVal) {
		return false
	}
	return true
}
...
var _ slog.LogValuer = (*Value)(nil)
...
var _ slog.LogValuer = (*NList)(nil)
...
func (p *DataSet) Equals(other *DataSet) bool {
	...
	for i, _tgt := range p.ColumnNames {
		...
		if bytes.Compare(_tgt, _src11) != 0 {
			return false
		}
	}
...
var _ slog.LogValuer = (*DataSet)(nil)
...
func (p *Coordinate) LogValue() slog.Value {
	...
	v := thrift.SlogTStructWrapper{
		Type:  "*nebula.Coordinate",
		Value: p,
	}
	return slog.AnyValue(v)
}

var _ slog.LogValuer = (*Coordinate)(nil)
...
var _ slog.LogValuer = (*Point)(nil)
...
func (p *LineString) Equals(other *LineString) bool {
	...
	if len(p.CoordList) != len(other.CoordList) {
		return false
	}
...
func (p *LineString) LogValue() slog.Value {
	...
	v := thrift.SlogTStructWrapper{
		Type:  "*nebula.LineString",
		Value: p,
	}
	return slog.AnyValue(v)
}

var _ slog.LogValuer = (*LineString)(nil)
...
func (p *Polygon) Equals(other *Polygon) bool {
	...
	if len(p.CoordListList) != len(other.CoordListList) {
		return false
	}
	for i, _tgt := range p.CoordListList {
		_src17 := other.CoordListList[i]
		if len(_tgt) != len(_src17) {
			return false
		}
		for i, _tgt := range _tgt {
			_src18 := _src17[i]
			if !_tgt.Equals(_src18) {
				return false
			}
		}
	}
...
var _ slog.LogValuer = (*Polygon)(nil)
...
func (p *Geography) Equals(other *Geography) bool {
	...
	if !p.PtVal.Equals(other.PtVal) {
		return false
	}
	if !p.LsVal.Equals(other.LsVal) {
		return false
	}
	if !p.PgVal.Equals(other.PgVal) {
		return false
	}
	return true
}
...
func (p *Geography) LogValue() slog.Value {
	...
	v := thrift.SlogTStructWrapper{
		Type:  "*nebula.Geography",
		Value: p,
	}
	return slog.AnyValue(v)
}

var _ slog.LogValuer = (*Geography)(nil)
...
func (p *Tag) Equals(other *Tag) bool {
	...
	if len(p.Props) != len(other.Props) {
		return false
	}
...
var _ slog.LogValuer = (*Vertex)(nil)
...
func (p *Edge) Equals(other *Edge) bool {
	...
	if !p.Src.Equals(other.Src) {
		return false
	}
	if !p.Dst.Equals(other.Dst) {
		return false
	}
...
func (p *HostAddr) LogValue() slog.Value {
	...
	v := thrift.SlogTStructWrapper{
		Type:  "*nebula.HostAddr",
		Value: p,
	}
	return slog.AnyValue(v)
}

var _ slog.LogValuer = (*HostAddr)(nil)
...
func (p *Duration) Equals(other *Duration) bool {
	...
	if p.Microseconds != other.Microseconds {
		return false
	}
...
func (p *Duration) LogValue() slog.Value {
	...
	v := thrift.SlogTStructWrapper{
		Type:  "*nebula.Duration",
		Value: p,
	}
	return slog.AnyValue(v)
}

var _ slog.LogValuer = (*Duration)(nil)
...
func (p *LogInfo) Equals(other *LogInfo) bool {
	...
	if p.CommitLogID != other.CommitLogID {
		return false
	}
	if bytes.Compare(p.CheckpointPath, other.CheckpointPath) != 0 {
		return false
	}
	return true
}
...
var _ slog.LogValuer = (*LogInfo)(nil)
...
func (p *DirInfo) Equals(other *DirInfo) bool {
	...
	if bytes.Compare(p.Root, other.Root) != 0 {
		return false
	}
	...
	for i, _tgt := range p.Data {
		_src33 := other.Data[i]
		if bytes.Compare(_tgt, _src33) != 0 {
			return false
		}
	}
	return true
...
var _ slog.LogValuer = (*DirInfo)(nil)
...
func (p *CheckpointInfo) Equals(other *CheckpointInfo) bool {
	...
	if bytes.Compare(p.DataPath, other.DataPath) != 0 {
		return false
	}
	return true
}
...
func (p *CheckpointInfo) LogValue() slog.Value {
	...
	v := thrift.SlogTStructWrapper{
		Type:  "*nebula.CheckpointInfo",
		Value: p,
	}
	return slog.AnyValue(v)
}

var _ slog.LogValuer = (*CheckpointInfo)(nil)
...
func (p *LogEntry) Equals(other *LogEntry) bool {
	...
	if bytes.Compare(p.LogStr, other.LogStr) != 0 {
		return false
	}
	return true
}
...
func (p *LogEntry) LogValue() slog.Value {
	...
	v := thrift.SlogTStructWrapper{
		Type:  "*nebula.LogEntry",
		Value: p,
	}
	return slog.AnyValue(v)
}

var _ slog.LogValuer = (*LogEntry)(nil)
